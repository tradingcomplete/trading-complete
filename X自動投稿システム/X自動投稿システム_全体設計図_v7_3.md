# X自動投稿システム 全体設計図 v7.3

**プロジェクト名**: コンパナ FXサマリー自動投稿システム
**コンセプト**: 「毎回その瞬間の最新情報で作成・即投稿」
**更新日**: 2026-03-15
**v7.3変更点**: 後処理チェーン追加強化・プロンプト品質改善・importFromRawSheet新形式対応・WEEKLY_LEARNING架空失敗談禁止
...
testAll1()                  分割テスト グループ1（MORNING/TOKYO/LUNCH/LONDON） ✅安全 ★v7.2追加
testAll2()                  分割テスト グループ2（GOLDEN/NY/INDICATOR/KNOWLEDGE） ✅安全 ★v7.2追加
testAll3()                  分割テスト グループ3（WEEKLY_REVIEW/RULE_1〜3） ✅安全 ★v7.2追加
testAll4()                  分割テスト グループ4（RULE_4/WEEKLY_LEARNING/NEXT_WEEK/WEEKLY_HYPOTHESIS） ✅安全 ★v7.2追加
