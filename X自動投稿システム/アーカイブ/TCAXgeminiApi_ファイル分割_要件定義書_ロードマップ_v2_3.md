# geminiApi.gs ファイル分割 要件定義書 / ロードマップ v2.3

作成日: 2026-03-23
更新日: 2026-04-07（v2.3 v12.2反映: WTI/天然ガス停止+SH/SLダウ理論+週足シート+行数更新）
...
| 5 | config.gs | 624 | 6 | 設定値+POST_TYPES+確定データ ★v12.1.1: DAILY_RATE_COLS/WEEKLY_RATE_COLS追加 |
| 6 | factCheck.gs | 665 | 5 | ファクトチェック+自動修正 ★v12.1.1: WTI/天然ガス停止 |
| 7 | geminiApi.gs | 712 | 8 | 核: メイン処理+Claude市場分析+Gemini API通信 ★v12.2: ダウ理論詳細注入+WTI停止 |
...
| 11 | main.gs | 674 | - | カスタムメニュー+エントリポイント ★v12.2: パイプライン分割（Phase A/B） |
...
| 15 | promptBuilder.gs | 1,941 | 18 | プロンプト構築+データ注入 ★v12.2: 環境認識+仮説検証注入+未発表禁止+27:00対応 |
| 16 | qualityReview.gs | 483 | 8 | 品質レビュー Q1〜Q7 ★v12.2: 仮説矛盾+未発表チェック |
...
v2.3 設計図v12.2反映・WTI停止・SH/SLダウ理論・週足シート・行数更新
