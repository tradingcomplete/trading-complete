...
**最終更新**: 2026-04-30（v3.2・Premium AI機能要件定義書 v1.3 反映 / v1.2 archive 移動）
...
| 🌟 Premium AI機能戦略 | `docs/features/TC_Premium_AI機能_要件定義書_v1_3.md`（業務OS化・2026年9月リリース） |
...
│   ├── ⭐ TC_Premium_AI機能_要件定義書_v1_3.md  ← Premium戦略の正（業務OS化・2026年9月）
...
└── 📂 archive/              旧バージョン・廃止
    ...
    ├── TC_Premium_AI機能_要件定義書_v1_2.md（v1.3 で確定申告AI主役化・業務OS化に大幅改訂）
...
| 変更 | 理由 |
|---|---|
| **TC_Premium_AI機能_要件定義書 v1.2 → v1.3 へ大幅改訂** | 確定申告AIを Phase 1 主役化 / 業務OS戦略 / 投資効果ダッシュボード新規 / KPI を MRR→チャーン率へ |
| **v1.2 を archive へ移動** | 戦略レベルの根本変更のため、歴史的経緯として保管 |
| **CLAUDE.md / TASKS.md の Premium 戦略を v1.3 に同期** | リリース後ロードマップを Phase 1〜8 に整合 |

### 2026-04-30 v3.1 改訂

| 変更 | 理由 |
|---|---|
| Claude活用プロンプト集.md を新規追加 | A〜F カテゴリ別 30本のClaudeテンプレ集 |
