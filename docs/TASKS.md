...
*Premium 戦略: 業務OS化 / 確定申告AI主役化 / 自己投資の可視化（v1.3 確定）*
...
| **2026年9月** | **Premium プラン追加（v1.3 業務OS戦略）**: 確定申告AI主役・週次レビュー・投資効果ダッシュボード |

**料金プラン**: Free / Pro / Premium の3プラン構成（v3.10確定）
※価格・制限・早期割引の正は「決済システム要件定義書 v3.10」と「中核オファー要件定義書」を参照
※決済プロバイダの実装は v3.10 が一次資料
※Premium 機能戦略の正は **`docs/features/TC_Premium_AI機能_要件定義書_v1_3.md`** （確定申告AI主役化・業務OS化・自己投資の可視化）

### Premium ロードマップ（v1.3 戦略）

| 時期 | Phase | 内容 |
|------|-------|------|
| 2026年5-6月 | 設計詳細化・税制ロジック・e-Tax仕様確認 | リリース準備 |
| 2026年7-8月 | 実装フェーズ | プロンプト実装・ベータテスト |
| **2026年9月** | **Phase 1+2+3 リリース** | **確定申告AI / AIトレードコーチ / 投資効果ダッシュボード** |
| 2026年10月〜 | 行動データ分析開始 | 解約者アンケート・ヘビーユーザーインタビュー |
| 2026年11月 | 確定申告AI 本番運用 | 11月リマインド配信開始 |
| 2026年12月 | Phase 5+7 | 個人プレイブック・規律遵守率 |
| 2027年1-2月 | 確定申告期最大稼働 | 12-2月継続率測定（目標90%以上） |
| 2027年3月 | Phase 6 | 自然言語Q&A（Phase 2サブ機能化） |
| 2027年6月 | Phase 8 | スマートアラート |
...
| リリース後6ヶ月 | AI機能開発開始（v1.3 Phase 1〜3 リリース準備） |
...
| タスク | 優先度 | 工数 | 備考 |
|--------|--------|------|------|
| **Square Phase 10 本番切替（4-14〜4-19）** | **CRITICAL** | **約3h** | **リリース前必須・決済システム要件定義書 v3.10 §6 Step 4** |
| ~~Phase 11 サーバー側プラン制限~~ | - | - | ✅ 完了（2026-04-28） |
| ~~計算ロジック検証・修正フェーズ~~ | - | - | ✅ 完了（2026-04-30 検証9/9合格） |
| **Premium AI機能 Phase 1（確定申告AI）** | **2026年9月リリース・主役** | TBD | TC_Premium_AI機能_要件定義書_v1_3.md §6 |
| **Premium AI機能 Phase 2（AIトレードコーチ・週次レビュー）** | **2026年9月リリース・主役** | TBD | v1.3 §7 |
| **Premium AI機能 Phase 3（投資効果ダッシュボード）** | **2026年9月リリース・脇役** | TBD | v1.3 §8 |
| Premium AI機能 Phase 5（個人プレイブック自動生成） | 2026年12月 | TBD | v1.3 §5.2 |
| Premium AI機能 Phase 7（規律遵守率ダッシュボード） | 2026年12月 | TBD | v1.3 §5.2 |
| Premium AI機能 Phase 6（自然言語Q&A） | 2027年3月（Phase 2サブ） | TBD | v1.3 §5.2 |
| Premium AI機能 Phase 8（スマートアラート） | 2027年6月 | TBD | v1.3 §5.2 / §9 |
