...
> ⚠️ **2026-04-28 注記**: 価格・リリース時期の最新は `docs/marketing/Trading_Complete_中核オファー要件定義書_v1_0.md`（Pro¥1,980/Premium¥2,980 / リリース2026年夏）と `docs/features/決済システム要件定義書 v3.9.md`を参照。本文中の旧価格（¥2,480/¥3,980）・旧リリース時期（2026年3月）は無効。マーケティング戦略の本筋は有効。
